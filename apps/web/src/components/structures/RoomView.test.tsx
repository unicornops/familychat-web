...
describe("RoomView", () => {
    ...
    describe("when rendering a DM room with a single third-party invite", () => {
        ...
        it("should render the »waiting for third-party« view", () => {
            expect(screen.getByText("Waiting for users to join Family Chat")).toBeInTheDocument();
            expect(
                screen.getByText(
                    "Once invited users have joined Family Chat, you will be able to chat and the room will be end-to-end encrypted",
                ),
            ).toBeInTheDocument();
